...
st.set_page_config(page_title = " COVID-19 202", page_icon = ":bar_chart:" , layout= "wide")
...
if total_covid19_cases and total_covid19_deaths != 0:
   ...
   #Total Covid-19 Cases by Month [BarChart]
    ...
    fig_month_total = px.bar ( totalcovid19_cases_by_month, x = "Total Cases", y= totalcovid19_cases_by_month.index, orientation = "h", 
   ...
   Deaths_by_month.rename(index={1: 'Janaury', 2: 'February', 3: 'March', 4:'April', 5:'May', 6:'June', 7:'July'}, inplace = True)
